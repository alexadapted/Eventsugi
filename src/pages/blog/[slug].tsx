...
const BlogPage: NextPage = () => {
  ...
  const imageSrc = blog.slug === 'Corporate-Events-EventSugi' || blog.slug === 'new-years-party-planning-dubai' || blog.slug === 'christmas-decorations-corporate-events-uae' || blog.slug === 'proposal-planning-dubai' || blog.slug === 'UAE-National-Day-Event' || blog.slug === 'Eventsugi'
