...
const BlogPage: NextPage = () => {
  ...
  const imageSrc = blog.slug === 'Corporate-Events-EventSugi' || blog.slug ===  'social-gatherings-dubai' || blog.slug ===  'audio-visual-entertainment-solutions-dubai' || blog.slug ===  'furniture-rental-dubai'
